...
public class ProfessionalController 
{
    ...
    @GetMapping("/Index_Professional")

    public String Athelete()
    {
        return "Professional/Index_Professional";
    }

    @GetMapping("/Datos_Professional")
    ...
    public String Datos(HttpSession session, Model model)
    {
        ...
        if(people != null)
        {
            ...
            return "Professional/Datos_Professional";
        }
    ...
    @GetMapping("/Logout_Professional")
    public String logout_Professional(HttpSession session) 
    {
