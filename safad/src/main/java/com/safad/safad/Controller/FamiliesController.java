...
public class FamiliesController 
{
    ...
    @GetMapping("/Index_Families")

    public String Athelete()
    {
        return "Families/Index_Families";
    }

    @GetMapping("/Datos_Families")
    ...
    public String Datos(HttpSession session, Model model)
    {
        ...
        if(people != null)
        {
            ...
            return "Families/Datos_Families";
        }
    ...
    @GetMapping("/Logout_Families")
    public String logout_Families(HttpSession session) 
    {
